        ...
        <div class="col-lg-3 col-md-3">
          ...
          <ul class="list-unstyled clear-margins">
            ...
            <li class="widget-container widget_nav_menu">
              ...
              <h1 class="title-widget">Official as</h1>

              <ul>
                <li> 
                    <a href="https://ibps.in" >
                    IBPS
                      </a>
                </li>
                <li>
                    <a href="https://ibpsonline.ibps.in/sbijascapr21/" >
                    SBI Clerk 2021
                    </a>
                </li>
        ...
        <div class="col-lg-3 col-md-3">
          ...
          <ul class="list-unstyled clear-margins">
            ...
            <li class="widget-container widget_nav_menu">
              ...
              <h1 class="title-widget">Important as</h1>
        ...
        <div class="col-lg-3 col-md-3">
          ...
          <ul class="list-unstyled clear-margins">
            ...
            <li class="widget-container widget_nav_menu">
              ...
              <h1 class="title-widget">Helpful as</h1>
  ...
  <div class="row">
    ...
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
      ...
      <div class="copyright">
        ...
        ©  <span></span>  , MathHub-Combined , All rights reserved
